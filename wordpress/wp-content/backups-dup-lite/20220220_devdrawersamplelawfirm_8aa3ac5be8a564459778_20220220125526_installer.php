...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220220_devdrawersamplelawfirm_8aa3ac5be8a564459778_20220220125526_archive.zip';
	const ARCHIVE_SIZE		 = '40854688';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8aa3ac5-20125526';
    const SECONDARY_PACKAGE_HASH = '19ef1f7-20125526';
	const VERSION			 = '1.4.4';
